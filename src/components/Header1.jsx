...
export const Header1 = () => {
    ...
    // state to track if the contact form is opne
    ...
    <header className="absolute w-full z-50 transition-all duration-300">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
            ...
            className="flex items-center">
                ...
                <span className="relative hover:text-violet-600 text-xl font-bold bg-gradient-to-r from-gray-300 to-gray-100 bg-clip-text text-transparent group">
                SrvCodes
            ...
            <nav className="lg:flex hidden space-x-8">
                {
                    ["Home","About","Projects","Experience","Contact"].map((item,index)=>(
                        <motion.a
                         ...
                         className="relative text-white dark:text-gray-200 hover:text-violet-600 dark:hover:text-violet-400 font-medium transition-colors duration-300 group" href="#" >
                            {item}
                            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-violet-600 group-hover:w-full transition-all duration-300 "></span>
                        </motion.a>
                    ))
            ...
            <div className="md:flex hidden items-center space-x-4">
                ...
                href="https://github.com/Shrivatsa1" target="_blank" className="text-white-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 transition-colors duration-300">
            ...
            >
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                    <div className="flex space-x-5">
                        ...
                        <a href="#">
                            <FiCodepen  className="h-5 w-5 text-gray-300"  />
                        </a>
                    </div>
                </div>
